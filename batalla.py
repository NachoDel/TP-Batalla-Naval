...
------------------------------------------------------------------------------------------------
Pagina de donde se saco el codigo: https://parzibyte.me/blog/2021/12/21/batalla-naval-python-programacion-juego/
Repositorio de donde se descargo el codigo: https://github.com/parzibyte/juego_batalla_naval_python?tab=readme-ov-file
Explicacion del codigo: https://www.youtube.com/watch?v=43Vt9O_t4uY
------------------------------------------------------------------------------------------------
"""
import random
import os
